...
static const PinMap PinMap_I2C_SDA[] = {
    {PB_7,  I2C_1, STM_PIN_DATA(STM_PIN_MODE_OUTPUT_50MHZ, STM_PIN_CONF_OUTPUT_ALT_OPENDRAIN)},
    {PB_11, I2C_2, STM_PIN_DATA(STM_PIN_MODE_OUTPUT_50MHZ, STM_PIN_CONF_OUTPUT_ALT_OPENDRAIN)},
    {NC,    NC,    0}
};

static const PinMap PinMap_I2C_SCL[] = {
    {PB_6,  I2C_1, STM_PIN_DATA(STM_PIN_MODE_OUTPUT_50MHZ, STM_PIN_CONF_OUTPUT_ALT_OPENDRAIN)},
    {PB_10, I2C_2, STM_PIN_DATA(STM_PIN_MODE_OUTPUT_50MHZ, STM_PIN_CONF_OUTPUT_ALT_OPENDRAIN)},
    {NC,    NC,    0}
};
