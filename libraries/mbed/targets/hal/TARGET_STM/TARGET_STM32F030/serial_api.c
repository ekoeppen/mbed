...
static const PinMap PinMap_UART_TX[] = {
    {PA_9 , UART_1, STM_PIN_DATA(2, 1)},
    {PA_2 , UART_1, STM_PIN_DATA(2, 1)},
    {NC   , NC    , 0x00}
};

static const PinMap PinMap_UART_RX[] = {
    {PA_10, UART_1, STM_PIN_DATA(2, 1)},
    {PA_3,  UART_1, STM_PIN_DATA(2, 1)},
    {NC   , NC    , 0x00}
};
...
void serial_baud(serial_t *obj, int baudrate) {
    obj->uart->BRR = SystemCoreClock / baudrate;
}
...
void serial_format(serial_t *obj, int data_bits, SerialParity parity, int stop_bits) {
    ...
    if (stop_bits == 2) obj->uart->CR2 |= USART_CR2_STOP_1;
...
int serial_readable(serial_t *obj) {
    return obj->uart->ISR & USART_ISR_RXNE;
}

int serial_writable(serial_t *obj) {
    return obj->uart->ISR & USART_ISR_TC;
}

void serial_clear(serial_t *obj) {
    obj->uart->RQR |= USART_RQR_RXFRQ;
}
